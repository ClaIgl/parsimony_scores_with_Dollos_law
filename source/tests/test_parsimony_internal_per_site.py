...
@pytest.mark.parametrize("ch0_score,ch0_set,ch1_score,ch1_set,exp_score,exp_set,message",
    ...
    (1,set('-'),0,set('-'),1,set('-'),"two gap sets with non-zero score on first"),
    (0,set('-'),2,set('-'),2,set('-'),"two gap sets with non-zero score on second"),
    (1,set('-'),2,set('-'),3,set('-'),"two gap sets with non-zero scores"),
    (1,set(characters[0]),0,set('-'),2,set(characters[0]),"one non-empty set, single element"),
    (1,set(characters[0:2]),0,set('-'),2,set(characters[0:2]),"one non-empty set, two elements"),
    (1,set('-'),0,set(characters[1:3]),2,set(characters[1:3]),"second non-empty set, two elements"),
